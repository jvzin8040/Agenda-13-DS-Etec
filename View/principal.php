...
<body class="w3-white">
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais ">
        <h2 class="w3-text-cyan">Dados Pessoais</h2>
            ...
            <form action="" method="post" class="w3-light-grey w3-text-blue w3-margin" style="width: 700px; padding: 20px; border-radius: 10px;">
                ...
                <div class="w3-row w3-section">
                    <div class="w3-row w3-margin-bottom">
                        ...
                        <input class="w3-input w3-border w3-round-large w3-col" style="width: 85%;" name="txtNome" type="text" placeholder="Nome Completo">
                    </div>
                    <div class="w3-row w3-margin-bottom">
                        <i class="w3-xxlarge fa fa-calendar w3-col" style="width: 15%;"></i>
                        <input class="w3-input w3-border w3-round-large w3-col" style="width: 85%;" name="txtData" type="text" placeholder="dd/mm/aaaa">
                    </div>
                    <div class="w3-row w3-margin-bottom">
                        <i class="w3-xxlarge fa fa-address-card w3-col" style="width: 15%;"></i>
                        <input class="w3-input w3-border w3-round-large w3-col" style="width: 85%;" name="txtDocumento" type="text" placeholder="Documento">
                    </div>
                    <div class="w3-row w3-margin-bottom">
                        <i class="w3-xxlarge fa fa-envelope w3-col" style="width: 15%;"></i>
                        <input class="w3-input w3-border w3-round-large w3-col" style="width: 85%;" name="txtEmail" type="text" placeholder="Email">
                    </div>
